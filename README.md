...
Assembly commands can be found in [assembly](https://github.com/meghanclownfish/Nucella-lapillus-genome#:~:text=last%20week-,2_assembly,-Delete%202_assembly/hifiasm)
